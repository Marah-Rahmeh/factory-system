    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="row align-items-center my-4">
                <div class="col">
                    <h2 class="h3 mb-0 page-title">{{ __('Contracts') }}</h2>
                </div>
            </div>
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb ">
                                ...
                                <li class="breadcrumb-item"><a class="black-text active-2" href="#">{{ __('Contracts') }}</a>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="20" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"/>
                                      </svg>
                                </li>
            ...
            <tr>
                ...
                <td>
                    <form action="" method="POST" >
                        <p hidden>
                            {{ $count1 = count($project->where('p_contract_id', '=', $contract->id)) }}
                            </p>
                            @if($count1 > 0)
                            <p> </p>
                            @else

                            <a class="add" href={{ route('<project><id>add2',$contract->id) }}>
                ...
                <td>
                    <form action="" method="POST" >
                            <a class="show" href={{ route('<contract><id>show',$contract->id) }}>
                            ...
                            <a class="edit" href={{ route('<contract><id>edit',$contract->id) }}>
                            ...
                            @csrf
                            @method('DELETE')
                            <a class="delete" ref={{ route('<contract><id>delete',$contract->id) }}>
