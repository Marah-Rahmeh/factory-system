...
<br>
        ...
        <td valign='top' width='30%' style='font-size:12px;'>Contract start Date: {{ $contract->start_date }}<br/>
            <br>
      ...
      {{-- <tr>
      <td valign='top' width='30%' style='font-size:12px;'>delivery Date: {{ $contract->delivery_date }}<br/>
        <br/>
       </td>
       <tr> --}}
    ...
    <table width='100%' height='100' cellspacing='0' cellpadding='0'>
      <tr>
        <td><div align='center' style='font-size: 14px;font-weight: bold;'>Contract ID#   {{ $contract->id }}</div></td>
      </tr>
    </table>
...
<tr>
  ...
  <tr>
    ...
    <td  align='right' style='font-size:12px;'><b> {{ $contract->price_amount }} </b></td>
  </tr></table>
</td>
      </tr>
</table>
