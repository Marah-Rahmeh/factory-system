                ...
                <nav class="nav">
                    <div>
                        ...
                        <a href="">
                            ...
                            {{-- <img class="w-100" src="{{asset("storage/image/Logo-TR.png")}}" alt=""> --}}
                        </a>
                        <div class="nav_list">
                            ...
                            <a href="{{route('clients')}}" class="nav_link">
                                <i class='bx bx-user nav_icon'></i>
                                <span class="nav_name">Clients</span>
                            </a>
                            <a href="{{route('employees')}}" class="nav_link">
                            ...
                            <a href="{{route('proposals')}}" class="nav_link">
                            ...
                            <a href="{{route('contracts')}}" class="nav_link">
                                ...
                                <span class="nav_name">Contracts</span>
                            </a>
                            <a href="{{route('projects')}}" class="nav_link">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-kanban" viewBox="0 0 16 16">
