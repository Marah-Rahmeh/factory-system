        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="row align-items-center my-4">
                    <div class="col">
                        <h2 class="h3 mb-0 page-title">{{ __('Show Proposal') }}</h2>
                    </div>
                    <div class="col-auto">
                        {{-- @can('user-create') --}}
                            <a href= {{route('<proposal><id>print',$proposal->id)}} class="btn btn-success" style="color:white">
                        ...
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ __('Show Proposal') }}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-10">
          <div class="card mb-3">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm-3">
                  <h6 class="mb-0">Proposal Validity Date:</h6>
                </div>
                <div class="col-sm-9 text-secondary">
