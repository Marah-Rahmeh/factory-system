        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="row align-items-center my-4">
                    <div class="col">
                        <h2 class="h3 mb-0 page-title">{{ __('Show Client') }}</h2>
                    </div>
                </div>
                        ...
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ __('Show Client') }}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-body">
              <div class="d-flex flex-column align-items-center text-center">
                ...
                <div class="mt-3">
                  ...
                  <p class="text-secondary mb-1">{{ $client->mobile_number }}</p>
            ...
            <div class="card mb-3">
              <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="row">
                        <div class="col-sm-3">
                          <h6 class="mb-0">Contact Personal ID:</h6>
                        </div>
                        <div class="col-sm-9 text-secondary">
                            {{ $addresse->contact_personal_id }}
                        </div>
                      </div>
                      <hr>
